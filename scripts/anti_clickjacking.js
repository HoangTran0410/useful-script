    ...
    "function" != typeof String.prototype.includes &&
      ...
      (function (e, t) {
        ...
        function i(e) {
          return (
            !!e.hasAttribute("src") &&
            e.src.includes("facebook.com/plugins/like.php")
          );
        }
        function r(e) {
        ...
        function o() {
          ...
          null !== e &&
            i(e) &&
            (r(e), e.remove(), n('script[src*="likeme.js"]'));
        }
        t.storage.sync.get({ anti_clickjacking: !0 }, function (t) {
          t.anti_clickjacking &&
            (e.top === e && o(),
        ...
        var i = 0,
          ...
          f = function d() {
            ...
            for (var m in n)
              for (var p = n[m], g = p; g; ) {
                try {
                  var v = getComputedStyle(g);
                  if (v && parseFloat("0" + v.opacity) < 0.1) {
                    u("found", g, p), (c = o), (i = 0);
                    var y = g.id;
                    y || ((y = a + l), l++, (g.id = y)), f.push(y);
                  }
                } catch (h) {
                  u(h.message);
                }
            ...
            if (f.length > 0) {
              ...
              for (var w in f) {
                var E = f[w],
                  j = t.getElementById(E);
                if (
                  ("undefined" == typeof s[E] ? (s[E] = 1) : s[E]++, s[E] > 3)
                ) {
                  var b = t.getElementById(E);
                  null !== b && u("too many strikes, removed", E);
                } else
                  (j.style.opacity = 1),
              ...
              if (k.length > 0) {
                ...
                B.innerText = k;
                var C = t.getElementsByTagName("head");
                C.length > 0 && C[0].appendChild(B);
              }
            }
            i < r ? (i++, (c += i * o), e.setTimeout(d, c)) : u("stopped");
          };
        e.top === e && f();
